        ...
        <div className="flex items-center gap-1.5" ref={menuRef}>
                        ...
                        return (
                          <div
                            ...
                            className={`px-3 py-2 flex items-center justify-between text-xs cursor-pointer transition-colors ${
                              isSelected
                                ? 'bg-emerald-50 text-emerald-950 font-black border-l-4 border-emerald-600'
          ...
          {onOpenFinalizeModal && (
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1 text-xs font-black bg-emerald-800 hover:bg-emerald-900 text-white rounded-md transition-all shadow-xs cursor-pointer border border-emerald-600 ml-1"
